      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="text-center bg-white rounded-2xl p-8 shadow-lg">
          ...
          <p className="text-gray-600 mb-6">
            Create your own club and bring together people who share your interests
          </p>
          <div className="flex gap-4 justify-center">
            <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-lg hover:scale-105 transition-transform shadow-lg">
              Create Club
            </button>
            <button className="px-6 py-3 border-2 border-gray-300 text-gray-700 font-semibold rounded-lg hover:border-blue-400 hover:text-blue-600 transition-colors">
              Browse All Clubs
            </button>
          </div>
        </div>
