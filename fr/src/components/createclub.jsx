...
{
  return (
    <div class="flex justify-center items-center h-full font-ft flex-col">
      ...
      <div class="shadow-2xl w-[600px] h-[500px] p-10 rounded-2xl justify-center items-center ">
        ...
        <form class="flex flex-col pl-10">
          <div class="mb-4">
            ...
            <select class="rounded-lg h-8 w-60 p-1 shadow-md   border-gray-300 text-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
